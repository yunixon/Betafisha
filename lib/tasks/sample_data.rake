namespace :db do
  ...
  task :populate => :environment do
    ...
    User.create!( :name => "kirillivanov",
     ...
     Sport.create!( :name => "Баскетбол", :priority => 1)
     Sport.create!( :name => "Хоккей", :priority => 1) 
     Sport.create!( :name => "Волейбол", :priority => 1)
     Sport.create!( :name => "Формула 1", :priority => 1) 
     Sport.create!( :name => "Скачки", :priority => 1) 
     
     
      Sport.all.each do |sport|
        1.times do
          sport.countries.create!( :name => "Россия", :priority => 1)
          sport.countries.create!( :name => "Англия", :priority => 1)
          sport.countries.create!( :name => "Испания", :priority => 1)
          sport.countries.create!( :name => "Италия", :priority => 1)
          sport.countries.create!( :name => "Бразилия", :priority => 1)
          sport.countries.create!( :name => "Германия", :priority => 1)
        end
      end
      ...
      Country.all.each do |country|
        1.times do
          country.ligues.create!( :name => "Первая лига", :priority => 1)
